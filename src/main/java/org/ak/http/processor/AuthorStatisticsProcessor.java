...
import org.ak.step3.data.AuthorGroupStatistics;
import org.ak.step3.data.AuthorStatistics;
...
public class AuthorStatisticsProcessor extends BaseAnalysisProcessor {
    ...
    public String getTopContributors(AuthorStatistics authorStatistics) {
        return getJSONForTable(authorStatistics.getAuthorSummaries(), (as, result) -> {
            ...
            htmlWriter.appendLink(result, "files", "fsas", "showFilesModal", "files");
            htmlWriter.appendLink(result, "modules", "msas", "showFilesModal", true, "modules");
        });
    }
    ...
    public String getTopGroups(AuthorGroupStatistics contributions) {
        ...
        return getJSONForTable(collection, (name, result) -> {
            ...
            htmlWriter.appendLink(result, "files", "fsts", "showTeamFilesModal", "team_files", "files");
            htmlWriter.appendLink(result, "modules", "msts", "showTeamFilesModal", true, "team_modules", "modules");
        });
    }
